...
// 覆盖部分关键翻译（确保常用提示已翻译）
translations.fr.pleaseLogin = 'Veuillez vous connecter d\'abord';
translations.fr.sendCode = 'Envoyer le code';
translations.fr.codeSent = 'Code envoyé !';
translations.fr.registerSuccess = 'Inscription réussie !';
translations.fr.loginFailed = 'Échec de la connexion. Vérifiez vos identifiants.';
translations.de.pleaseLogin = 'Bitte melden Sie sich zuerst an';
translations.de.sendCode = 'Code senden';
translations.de.codeSent = 'Code gesendet!';
translations.de.registerSuccess = 'Registrierung erfolgreich!';
translations.de.loginFailed = 'Anmeldung fehlgeschlagen. Überprüfen Sie Ihre Anmeldedaten.';
translations.it.pleaseLogin = 'Effettua il login prima';
translations.it.sendCode = 'Invia codice';
translations.it.codeSent = 'Codice inviato!';
translations.it.registerSuccess = 'Registrazione riuscita!';
translations.it.loginFailed = 'Accesso fallito. Controlla le tue credenziali.';
translations.pt.pleaseLogin = 'Faça login primeiro';
translations.pt.sendCode = 'Enviar código';
translations.pt.codeSent = 'Código enviado!';
translations.pt.registerSuccess = 'Registro bem-sucedido!';
translations.pt.loginFailed = 'Falha no login. Verifique suas credenciais.';
