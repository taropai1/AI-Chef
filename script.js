...
const translations = {
  en: {
    ...
    ask: 'Ask', dishNameHint: 'Enter keywords like ingredients, dish names, or food items.', watchVideo: 'Watch Video Guides',
    ...
    personalizedGreeting: 'Dear {{name}}, your delicious recipe is ready. Enjoy your meal! 🌹', save: 'Save', edit: 'Edit',
    change: 'Change', pleaseLogin: 'Please login first', sendCode: 'Send code', sending: 'Sending...', codeSent: 'Verification code sent!',
  ...
  'zh-CN': {
    ...
    ask: '提问', dishNameHint: '可输入食材、菜名、食品名称等关键词', watchVideo: '观看视频指南', addToHome: '添加',
    ...
    legalTermsSub10: '6.10 本站拥有最终解释权。', success: '成功', ok: '确定', personalizedGreeting: '亲爱的{{name}}，已为您生成美味菜谱，祝您用餐愉快🌹',
  ...
  es: {
    ...
    feat1Sub: 'Sabores globales', feat2: 'Asistente IA', feat2Sub: '5 preguntas por receta', feat3: 'Nutrición',
    feat3Sub: 'Peso saludable', feat4: 'Seguro para bebés', feat4Sub: 'Sin sal/azúcar', feat5: 'Embarazo',
    feat5Sub: 'Amigable para mamá', feat6: 'Guías en video', feat6Sub: 'Paso a paso', sectionSubscribe: 'Planes de suscripción',
    subText: 'Suscribirse', subSub: 'Acceso completo', familyText: 'Compartir en familia', familySub: 'Solo Premium',
    legalLink: 'Privacidad/Términos', genTitle: 'Generador de recetas IA', genMealType: 'Categoría', genCuisine: 'Cocina',
    genDishName: '¿Qué quieres comer?', optStandard: 'Estándar', optBaby: 'Bebé', optPregnancy: 'Embarazo',
    generate: 'Generar receta', generating: 'Generando...', aiAssistTitle: 'Asistente IA', enterQuestion: 'Pregunta sobre esta receta...',
    ask: 'Preguntar', dishNameHint: 'Puedes ingresar uno o más ingredientes.', watchVideo: 'Ver guías en video', addToHome: 'Agregar',
    ...
    businessDesc: '300 recetas/día · 5 preguntas · Uso comercial', finePrint: 'Al suscribirte aceptas nuestros ', loginTitle: 'Iniciar sesión',
    registerTitle: 'Registrarse', email: 'Correo electrónico', password: 'Contraseña', confirmPwd: 'Confirmar contraseña',
    forgot: '¿Olvidaste tu contraseña?', noAccount: '¿No tienes una cuenta?', signUp: 'Registrarse', signIn: 'Iniciar sesión',
    haveAccount: '¿Ya tienes una cuenta?', forgotTitle: 'Restablecer contraseña', cancel: 'Cancelar', reset: 'Restablecer',
    profileNickname: 'Apodo', profileEmail: 'Correo', profilePlan: 'Plan', profileJoined: 'Registrado', logout: 'Cerrar sesión',
    profileSub: 'Mi suscripción', subStatus: 'Estado', subExpiry: 'Expira', inviteCodeTitle: 'Código de invitación', joinFamily: 'Unirse',
    nicknameTitle: 'Cambiar apodo', emailTitle: 'Cambiar correo', legalPrivacyTitle: 'Política de privacidad',
    legalEffDate: 'Fecha de vigencia: 2025-01-01', legalPrivacyCollect: '1. Información que recopilamos',
    ...
    personalizedGreeting: 'Estimado {{name}}, tu deliciosa receta está lista. ¡Disfruta tu comida! 🌹', save: 'Guardar', edit: 'Editar',
    change: 'Cambiar', pleaseLogin: 'Inicia sesión primero', sendCode: 'Enviar código', sending: 'Enviando...', codeSent: '¡Código enviado!',
  ...
  fr: {
    heroSubtitle: 'Cuisines mondiales · Association intelligente', sectionFeatures: 'Fonctionnalités', feat1: '18 cuisines',
    feat1Sub: 'Saveurs du monde', feat2: 'Assistant IA', feat2Sub: '5 questions par recette', feat3: 'Nutrition',
    feat3Sub: 'Poids santé', feat4: 'Sécurité bébé', feat4Sub: 'Sans sel/sucre', feat5: 'Grossesse', feat5Sub: 'Adapté aux mamans',
    feat6: 'Guides vidéo', feat6Sub: 'Pas à pas', sectionSubscribe: 'Formules d\'abonnement', subText: 'S\'abonner',
    subSub: 'Accès complet', familyText: 'Partage familial', familySub: 'Premium uniquement', legalLink: 'Confidentialité/Conditions',
    genTitle: 'Générateur de recettes IA', genMealType: 'Catégorie', genCuisine: 'Cuisine', genDishName: 'Que manger ?',
    optStandard: 'Standard', optBaby: 'Bébé', optPregnancy: 'Grossesse', generate: 'Générer une recette', generating: 'Génération...',
    aiAssistTitle: 'Assistant IA', enterQuestion: 'Posez une question sur cette recette...', ask: 'Demander',
    dishNameHint: 'Vous pouvez entrer un ou plusieurs ingrédients.', watchVideo: 'Regarder les guides vidéo', addToHome: 'Ajouter',
    ...
    forgot: 'Mot de passe oublié ?', noAccount: 'Pas de compte ?', signUp: 'S\'inscrire', signIn: 'Se connecter', haveAccount: 'Déjà un compte ?',
    forgotTitle: 'Réinitialiser le mot de passe', cancel: 'Annuler', reset: 'Réinitialiser', profileNickname: 'Surnom',
    profileEmail: 'E-mail', profilePlan: 'Forfait', profileJoined: 'Inscrit le', logout: 'Déconnexion', profileSub: 'Mon abonnement',
    subStatus: 'Statut', subExpiry: 'Expire', inviteCodeTitle: 'Code d\'invitation', joinFamily: 'Rejoindre', nicknameTitle: 'Changer de surnom',
    ...
    personalizedGreeting: 'Cher {{name}}, votre délicieuse recette est prête. Bon appétit ! 🌹', save: 'Enregistrer', edit: 'Modifier',
    change: 'Changer', pleaseLogin: 'Veuillez vous connecter d\'abord', sendCode: 'Envoyer le code', sending: 'Envoi...',
    codeSent: 'Code envoyé !', codeSendFailed: 'Échec de l\'envoi du code. Veuillez réessayer.', registerSuccess: 'Inscription réussie !',
    loginFailed: 'Échec de la connexion. Vérifiez vos identifiants.', pricingSubtitle: 'Choisissez votre formule', pricingTitle: 'Formules d\'abonnement',
    planStarterName: 'Starter', planStarterDesc: 'Votre assistant culinaire personnel', planStarterPeriod: '/ mois',
    planProName: 'Pro', planProDesc: 'Le plus populaire parmi les gourmets', planProPeriod: '/ mois',
    ...
    subscribeBtn: 'S\'abonner maintenant', planNotice: 'Sécurisé par PayPal · Renouvellement automatique',
    featureStarter1: '10 recettes par jour', featureStarter2: '5 questions IA par recette', featureStarter3: 'Usage personnel uniquement',
    featureStarter4: 'Générez des recettes avec tous les ingrédients', featurePro1: '30 recettes par jour', featurePro2: '5 questions IA par recette',
    featurePro3: 'Toutes les fonctionnalités débloquées', featurePro4: 'Personnalisation avancée des recettes',
    featurePremium1: '80 recettes par jour', featurePremium2: '5 questions IA par recette', featurePremium3: 'Jusqu\'à 3 utilisateurs en partage',
    featurePremium4: 'Pool d\'utilisation partagé', featurePremium5: 'Analyse santé et nutrition', featureBusiness1: '300 générations par jour',
    featureBusiness2: '5 questions IA par recette', featureBusiness3: 'File de génération prioritaire', featureBusiness4: 'Droits d\'utilisation commerciale',
    featureBusiness5: 'Autorisations étendues sur les recettes', freeTierDesc: 'Vous êtes sur le niveau gratuit.',
  ...
  de: {
    heroSubtitle: 'Globale Küchen · Intelligente Kombination', sectionFeatures: 'Funktionen', feat1: '18 Küchen',
    feat1Sub: 'Weltweite Aromen', feat2: 'KI-Assistent', feat2Sub: '5 Fragen pro Rezept', feat3: 'Ernährung',
    feat3Sub: 'Gesundes Gewicht', feat4: 'Babysicher', feat4Sub: 'Ohne Salz/Zucker', feat5: 'Schwangerschaft',
    feat5Sub: 'Mama-freundlich', feat6: 'Videoanleitungen', feat6Sub: 'Schritt für Schritt', sectionSubscribe: 'Abonnementpläne',
    subText: 'Abonnieren', subSub: 'Vollen Zugriff erhalten', familyText: 'Familienfreigabe', familySub: 'Nur Premium',
    legalLink: 'Datenschutz/AGB', genTitle: 'KI-Rezeptgenerator', genMealType: 'Kategorie', genCuisine: 'Küche',
    genDishName: 'Was möchtest du essen?', optStandard: 'Standard', optBaby: 'Baby', optPregnancy: 'Schwangerschaft',
    generate: 'Rezept generieren', generating: 'Generiere...', aiAssistTitle: 'KI-Assistent', enterQuestion: 'Frage zu diesem Rezept...',
    ask: 'Fragen', dishNameHint: 'Du kannst eine oder mehrere Zutaten eingeben.', watchVideo: 'Videoanleitungen ansehen',
    addToHome: 'Hinzufügen', freeLimitInfo: 'Kostenlose Testversion: {{used}}/3', starterInfo: 'Starter: {{used}}/10 | Fragen übrig: {{qLeft}}',
    ...
    forgot: 'Passwort vergessen?', noAccount: 'Kein Konto?', signUp: 'Registrieren', signIn: 'Anmelden', haveAccount: 'Bereits ein Konto?',
    forgotTitle: 'Passwort zurücksetzen', cancel: 'Abbrechen', reset: 'Zurücksetzen', profileNickname: 'Spitzname',
    profileEmail: 'E-Mail', profilePlan: 'Plan', profileJoined: 'Registriert', logout: 'Abmelden', profileSub: 'Mein Abonnement',
    subStatus: 'Status', subExpiry: 'Läuft ab', inviteCodeTitle: 'Einladungscode', joinFamily: 'Beitreten', nicknameTitle: 'Spitzname ändern',
    ...
    legalTermsLaw: '5. Anwendbares Recht', legalTerms5: 'Anwendbares Recht: dein Gerichtsstand.',
    legalTermsSubRules: '6. Abonnementregeln', legalTermsSub1: '6.1 Abonnenten haben nach der Anmeldung Zugriff.',
    ...
    personalizedGreeting: 'Liebe/r {{name}}, dein köstliches Rezept ist fertig. Genieße deine Mahlzeit! 🌹', save: 'Speichern', edit: 'Bearbeiten',
    change: 'Ändern', pleaseLogin: 'Bitte melde dich zuerst an', sendCode: 'Code senden', sending: 'Sende...', codeSent: 'Code gesendet!',
    ...
    subscribeBtn: 'Jetzt abonnieren', planNotice: 'Gesichert durch PayPal · Automatische Verlängerung',
    featureStarter1: '10 Rezepte täglich', featureStarter2: '5 KI-Fragen pro Rezept', featureStarter3: 'Nur für den persönlichen Gebrauch',
    featureStarter4: 'Rezepte aus beliebigen Zutaten generieren', featurePro1: '30 Rezepte täglich', featurePro2: '5 KI-Fragen pro Rezept',
    featurePro3: 'Alle Funktionen freigeschaltet', featurePro4: 'Erweiterte Rezeptanpassung', featurePremium1: '80 Rezepte täglich',
    featurePremium2: '5 KI-Fragen pro Rezept', featurePremium3: 'Bis zu 3 Benutzer teilen', featurePremium4: 'Gemeinsamer Nutzungspool',
    featurePremium5: 'Gesundheits- und Ernährungsanalyse', featureBusiness1: '300 tägliche Generierungen', featureBusiness2: '5 KI-Fragen pro Rezept',
    featureBusiness3: 'Priorisierte Generierungswarteschlange', featureBusiness4: 'Kommerzielle Nutzungsrechte',
    featureBusiness5: 'Erweiterte Rezeptberechtigungen', freeTierDesc: 'Sie befinden sich in der kostenlosen Stufe.',
  ...
  it: {
    heroSubtitle: 'Cucine globali · Abbinamento intelligente', sectionFeatures: 'Caratteristiche', feat1: '18 cucine',
    feat1Sub: 'Sapori globali', feat2: 'Assistente AI', feat2Sub: '5 domande per ricetta', feat3: 'Nutrizione',
    feat3Sub: 'Peso sano', feat4: 'Sicuro per neonati', feat4Sub: 'Senza sale/zucchero', feat5: 'Gravidanza',
    feat5Sub: 'Amico della mamma', feat6: 'Guide video', feat6Sub: 'Passo dopo passo', sectionSubscribe: 'Piani di abbonamento',
    subText: 'Abbonati', subSub: 'Accesso completo', familyText: 'Condivisione familiare', familySub: 'Solo Premium',
    legalLink: 'Privacy/Termini', genTitle: 'Generatore di ricette AI', genMealType: 'Categoria', genCuisine: 'Cucina',
    genDishName: 'Cosa vuoi mangiare?', optStandard: 'Standard', optBaby: 'Bebè', optPregnancy: 'Gravidanza',
    ...
    ask: 'Chiedi', dishNameHint: 'Puoi inserire uno o più ingredienti.', watchVideo: 'Guarda le guide video', addToHome: 'Aggiungi',
    ...
    forgot: 'Password dimenticata?', noAccount: 'Non hai un account?', signUp: 'Registrati', signIn: 'Accedi', haveAccount: 'Hai già un account?',
    ...
    legalTermsLaw: '5. Legge applicabile', legalTerms5: 'Legge applicabile: la tua giurisdizione.',
    legalTermsSubRules: '6. Regole di abbonamento', legalTermsSub1: '6.1 Gli abbonati hanno accesso al login.',
    ...
    personalizedGreeting: 'Caro {{name}}, la tua deliziosa ricetta è pronta. Buon appetito! 🌹', save: 'Salva', edit: 'Modifica',
    change: 'Cambia', pleaseLogin: 'Effettua il login prima', sendCode: 'Invia codice', sending: 'Invio...', codeSent: 'Codice inviato!',
  ...
  pt: {
    heroSubtitle: 'Cozinhas globais · Combinação inteligente', sectionFeatures: 'Características', feat1: '18 cozinhas',
    feat1Sub: 'Sabores globais', feat2: 'Assistente IA', feat2Sub: '5 perguntas por receita', feat3: 'Nutrição',
    feat3Sub: 'Peso saudável', feat4: 'Seguro para bebês', feat4Sub: 'Sem sal/açúcar', feat5: 'Gravidez',
    feat5Sub: 'Amigável para mamãe', feat6: 'Guias em vídeo', feat6Sub: 'Passo a passo', sectionSubscribe: 'Planos de assinatura',
    subText: 'Assinar', subSub: 'Acesso completo', familyText: 'Compartilhamento familiar', familySub: 'Apenas Premium',
    legalLink: 'Privacidade/Termos', genTitle: 'Gerador de receitas IA', genMealType: 'Categoria', genCuisine: 'Cozinha',
    genDishName: 'O que comer?', optStandard: 'Padrão', optBaby: 'Bebê', optPregnancy: 'Gravidez', generate: 'Gerar receita',
    generating: 'Gerando...', aiAssistTitle: 'Assistente IA', enterQuestion: 'Pergunte sobre esta receita...', ask: 'Perguntar',
    dishNameHint: 'Você pode inserir um ou mais ingredientes.', watchVideo: 'Assistir guias em vídeo', addToHome: 'Adicionar',
    ...
    forgot: 'Esqueceu a senha?', noAccount: 'Não tem uma conta?', signUp: 'Registrar', signIn: 'Entrar', haveAccount: 'Já tem uma conta?',
    ...
    personalizedGreeting: 'Caro {{name}}, sua deliciosa receita está pronta. Aproveite sua refeição! 🌹', save: 'Salvar', edit: 'Editar',
    change: 'Alterar', pleaseLogin: 'Faça login primeiro', sendCode: 'Enviar código', sending: 'Enviando...', codeSent: 'Código enviado!',
...
function restoreRecentRecipes() { const cached = localStorage.getItem('recipeHistory'); if (!cached || JSON.parse(cached).length===0) { showToast('No cached recipes found.'); return; } const recent = JSON.parse(cached).slice(-3); const resultEl = document.getElementById('recipeResult'); resultEl.innerHTML = '<div style="font-size:14px;color:#64788b;margin-bottom:8px;">📜 最近3条记录：</div>' + recent.map((r,i)=>`<div style="margin-bottom:6px;">${i+1}. ${r.substring(0,100)}${r.length>100?'…':''}</div>`).join(''); }
function showPrevRecipe() { if (historyIndex > 0) { historyIndex--; const recipe = recipeHistory[historyIndex]; document.getElementById('recipeResult').innerText = recipe; userData.lastRecipeText = recipe; document.getElementById('qaHistory').innerText = ''; } updateHistoryButtons(); }
function showNextRecipe() { if (historyIndex < recipeHistory.length - 1) { historyIndex++; const recipe = recipeHistory[historyIndex]; document.getElementById('recipeResult').innerText = recipe; userData.lastRecipeText = recipe; document.getElementById('qaHistory').innerText = ''; } updateHistoryButtons(); }
...
// ==================== 视频 ====================
function showVideo() { const dish = document.getElementById('dishName').value.trim() || 'recipe'; const cuisine = document.getElementById('cuisine').value; document.getElementById('videoFrame').src = `https://www.youtube.com/embed?listType=search&list=${encodeURIComponent(`${cuisine} ${dish} cooking`)}`; document.getElementById('videoContainer').style.display = 'block'; }
